...
def main():
    ...
    input_file = '0-Datasets/Covid Data.csv'
    output_file = '0-Datasets/Covid Data_Clear.csv'
...
def UpdateMissingValues(df, column, method="mode", number=0):
    if method == 'number':
        # Substituindo valores ausentes por um númerohttp://archive.ics.uci.edu/ml/datasets/Flags
