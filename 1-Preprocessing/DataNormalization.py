...
def main():
    ...
    input_file = '0-Datasets/covid_worldwideClear.csv'
    names = ['Country, Total Cases, Total Deaths, Total Recovered, Active Cases, Total Test, Population']
    features = ['Country, Total Cases, Total Deaths, Total Recovered, Active Cases, Total Test, Population']
    target = 'Total Deaths'
